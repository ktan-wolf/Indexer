...
//     &data[8..] // skip first 8 bytes
// }

// fn deserialize_node_device(data: &[u8]) -> Result<NodeDevice, Box<dyn std::error::Error>> {
//     let nd = NodeDevice::try_from_slice(skip_anchor_discriminator(data))?;
//     Ok(nd)
// }
...
//     fetch_program_accounts(rpc_url , program_id , &pool).await?;

//     // // Insert into nodes
//     // sqlx::query(
//     //     "INSERT INTO nodes (pubkey, authority, uri) VALUES ($1, $2, $3)"
//     // )
//     // .bind("SomePubkey456")
//     // .bind("SomeAuthority789")
//     // .bind("https://example.com/node/2")
//     // .execute(&pool)
//     // .await?;

//     // println!("✅ Inserted into nodes");

//     // // Insert into network_stats
//     // sqlx::query(
//     //     "INSERT INTO network_stats (total_nodes) VALUES ($1)"
//     // )
//     // .bind(1_i64)
//     // .execute(&pool)
//     // .await?;

//     // println!("✅ Inserted into network_stats");
...
//     //         uri = EXCLUDED.uri
//     //     "#,
//     //     pubkey.to_string(),           // account pubkey
//     //     node.authority.to_string(),   // authority pubkey
//     //     node.uri                      // URI string
//     // )
//     // .execute(&pool)
//     // .await?;
...
// async fn fetch_program_accounts(rpc_url : &str , program_id : &str , pool : &sqlx::PgPool) -> Result<(), Box<dyn std::error::Error>>{
//     let client = RpcClient::new(rpc_url.to_string());
...
//         if data_len == 8 + 32 + 4 + 256 {
//             let node = deserialize_node_device(data)?;
...
//             let stats = deserialize_network_stats(data)?;
//             println!("NetworkStats: {:?}", stats);

//             // UPSERT into network_stats (always id=1)
//             sqlx::query(
//                 r#"
...
//             .await?;
//         } else {
//             println!("Unknown account type, size: {}", data_len);
//         }
//     }
...
//             // NodeDevice accounts (discriminator + authority + string)
...
//             if let Ok(stats) = deserialize_network_stats(&account.data) {
//                 println!("NetworkStats: {:?}", stats);
